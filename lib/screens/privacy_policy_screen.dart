    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Semantics(
          header: true,
          child: Text('Privacy & Data Policy'),
        ),
        centerTitle: true,
        elevation: 0,
...
class _Heading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Semantics(
        header: true, // Tells screen readers this is a section break
        child: Text(
          text.toUpperCase(),
...
class _Body extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return MergeSemantics( // Groups the paragraph so it's read as one unit
      child: Text(
        text,
