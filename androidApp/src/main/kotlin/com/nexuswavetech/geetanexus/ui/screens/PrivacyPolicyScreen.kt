    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            privacySection("4. Data Storage",
                "Most of your data (bookmarks, reading progress, journal entries) is stored **locally on your device** using Android DataStore. We do not store this data on our servers.\n\nWhen you use Aira AI, your question is sent to Google Gemini (via our secure Cloudflare gateway) and our FastAPI backend. These requests are not stored permanently.\n\nWe use Cloudflare Workers as an API gateway. Cloudflare may log metadata such as request timestamps and IP addresses per their own Privacy Policy.")
